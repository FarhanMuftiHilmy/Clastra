    ...
    <div id="auth-screen" className="min-h-screen flex flex-col justify-center items-center bg-slate-50 px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">School Class Management</h1>
          <p className="text-xs text-slate-500 mt-1.5 font-medium">Academics, Attendance & Analytics Portal</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={selectedRole === 'admin' ? 'admin@school.edu' : 'teacher@school.edu'}
              />
            </div>
          </div>
